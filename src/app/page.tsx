  ...
  return (
    <div className="pt-8">
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Link
          href="/about"
          className="md:col-span-2 md:row-span-2 bento-card bg-[#201f1f] border border-[#3c4948]/20 rounded-xl overflow-hidden relative group min-h-64"
        >
          <Image
        ...
        <a
          ...
          className="md:col-span-2 bento-card bg-[#2a2a2a] border border-[#3c4948]/20 rounded-xl overflow-hidden relative flex flex-col justify-between group min-h-48"
        >
          <Image
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="md:col-span-2 bento-card bg-[#201f1f] border border-[#3c4948]/20 rounded-xl overflow-hidden relative group min-h-48"
        >
          <Image
        ...
        <Link
          href="/videos"
          className="md:col-span-2 bento-card bg-[#1c1b1b] border border-[#3c4948]/20 rounded-xl overflow-hidden relative flex flex-col justify-between group min-h-48"
        >
          <Image
